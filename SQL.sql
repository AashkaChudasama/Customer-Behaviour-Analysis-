...
--Q7. Segment customerws into New, Returning and Loyal based on their total number of
...
--Q9. Are customers who are repeat buyer (more the 5 previous purchases) also likely to subscribe?
...
select age_group, COUNT(purchase_amount) as total_ravenue
from customer
group by age_group
